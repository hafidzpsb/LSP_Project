  ...
  <body>
    ...
    <header>
      <!-- <section>
        ...
        <div>
          <center><h1 style="font-weight: 500;">#deliveryourhope</h1></center>
        </div>
      </section> -->
      ...
      <div class="container" style="max-width: 800px;">
        <div class="container">
          ...
          <div class="col-md-10">
            ...
            <div class="mb-3">
              <div class="">
                <h6 class="text-start">Class</h6>
                  <select class="form-select" aria-label="Default select example" name="car">
                    <option selected>Select Class</option>
                    <option value="Honda Brio">Jakarta</option>
                    <option value="Toyota Ayla">Economy</option>
                    <option value="Toyota Rush">Business</option>
                    <option value="Toyota Rush">VIP</option>
                  </select>
              </div>
            </div>
            <div class="mb-3">
              <div class="">
                <h6 class="text-start">Your Location</h6>
                  <select class="form-select" aria-label="Default select example" name="car">
            ...
            <div class="mb-3">
              <div class="">
                <h6 class="text-start">Your Destination</h6>
                  <select class="form-select" aria-label="Default select example" name="car">
            ...
            <div class="mb-3">
              <div class="">
                <h6 class="text-start">Select Seat</h6>
                  <select class="form-select" aria-label="Default select example" name="car">
            ...
            <center>
              <a href="checkout.html">
                <button style="margin-bottom: 50px;" type="button" class="btn btn-danger">Book</button>
              </a>
            </center>
          </center>
          <!-- <center>
